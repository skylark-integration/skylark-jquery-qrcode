...
define('skylark-jquery-qrcode/QRMode',[],function(){
	//---------------------------------------------------------------------
	// QRMode
	//---------------------------------------------------------------------
...
define('skylark-jquery-qrcode/jquery.qrcode',[
	"skylark-jquery",
	"./QRCode",
	"./QRErrorCorrectLevel"
...
define('skylark-jquery-qrcode/main',[
	"./jquery.qrcode"
],function($){
	return $;
});
define('skylark-jquery-qrcode', ['skylark-jquery-qrcode/main'], function (main) { return main; });


},this);
//# sourceMappingURL=sourcemaps/skylark-jquery-qrcode-all.js.map
